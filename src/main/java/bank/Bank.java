...
public interface Bank {
     ...
     */
    List<Transaction> getTransactions(String account) throws IOException, AccountDoesNotExistException;
     ...
     */
    List<Transaction> getTransactionsSorted(String account, boolean asc) throws IOException, AccountDoesNotExistException;
     ...
     */
    List<Transaction> getTransactionsByType(String account, boolean positive) throws IOException, AccountDoesNotExistException;
